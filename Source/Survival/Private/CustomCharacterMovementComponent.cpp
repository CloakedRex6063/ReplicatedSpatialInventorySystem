...
void UCustomCharacterMovementComponent::ActivateMovementFlag(EMovementFlag FlagToActivate)
{
    MovementFlagCustom |= FlagToActivate;
}

void UCustomCharacterMovementComponent::ClearMovementFlag(EMovementFlag FlagToClear)
{
...
/*
void UCustomCharacterMovementComponent::SetCustomFlag(ECompressedFlags flag)
{
   // CustomFlags |= flag;
}
*/
/*
void UCustomCharacterMovementComponent::ClearCustomCompressedFlag(ECompressedFlags flag)
{
    //CustomFlags &= ~flag;
}
*/
...
void UCustomCharacterMovementComponent::PhysCustom(float deltaTime, int32 Iterations)
{
    ...
    ABaseCharacterC* BaseCharacterC = static_cast<ABaseCharacterC*>(PawnOwner);
    if (BaseCharacterC)
    {
        BaseCharacterC->PhysNetCustom(deltaTime, Iterations);
    }
}
...
//Setting Values
void UCustomCharacterMovementComponent::SetMaxGroundSpeed(float NewMaxGroundSpeed)
{
    MaxGroundSpeed = NewMaxGroundSpeed;
}

void UCustomCharacterMovementComponent::SetGroundFriction(float NewGroundFriction)
{
    CustomGroundFriction = NewGroundFriction;
}

void UCustomCharacterMovementComponent::SetMaxGravity(float NewMaxGravity)
{
    MaxGravity = NewMaxGravity;
}

void UCustomCharacterMovementComponent::SetPlaneConstraintReplicated(FVector NewPlaneConstraint)
{
    PlaneConstraint = NewPlaneConstraint;
}

void UCustomCharacterMovementComponent::SetMaxAcceleration(float NewAcceleration)
{
    MaxAccelerationCustom = NewAcceleration;
}

void UCustomCharacterMovementComponent::SetMaxJumpHeight(float NewJumpHeight)
{
    MaxJumpHeightCustom = NewJumpHeight;
}

void UCustomCharacterMovementComponent::SetAirControl(float NewAirControl)
{
    AirControlCustom = NewAirControl;
}

void UCustomCharacterMovementComponent::SetCrouchedHalfHeight(float NewCrouchedHalfHeight)
{
    CustomCrouchHalfHeight = NewCrouchedHalfHeight;
}

void UCustomCharacterMovementComponent::StopNewMovementMode()
{
    ClearMovementFlag(EMovementFlag::CFLAG_NewMovementMode);
}

void UCustomCharacterMovementComponent::SetMaxSpeedCrouched(float NewCrouchSpeed)
{
    MaxSpeedCrouched = NewCrouchSpeed;
}

void UCustomCharacterMovementComponent::LaunchCharacterReplicated(FVector NewLaunchVelocity, bool bXYOverride, bool bZOverride)
{
...
void UCustomCharacterMovementComponent::SafeMoveUpdatedVelocity(float DeltaTime, bool Sweep)
{
    FHitResult Hit(1.f);
...
void UCustomCharacterMovementComponent::SafeMoveUpdatedLocation(const FVector NewLocation, bool Sweep)
{
    FHitResult Hit;
...
void UCustomCharacterMovementComponent::SetMovementModeRep(EMovementMode NewMovementMode, uint8 NewCustomMovementMode)
{
...
void UCustomCharacterMovementComponent::ClientSetMovementMode_Implementation(EMovementMode NewMovementMode, uint8 NewCustomMovementMode)
{
    SetMovementMode(NewMovementMode, NewCustomMovementMode);
}

void UCustomCharacterMovementComponent::ServerSetMovementMode_Implementation(EMovementMode NewMovementMode, uint8 NewCustomMovementMode)
{
    SetMovementMode(NewMovementMode, NewCustomMovementMode);
}
#pragma endregion
...
void UCustomCharacterMovementComponent::OnMovementUpdated(float DeltaSeconds, const FVector& OldLocation, const FVector& OldVelocity)
{
    ...
    if (BaseCharacterC)
    {
        BaseCharacterC->OnMovementUpdatedCustom(DeltaSeconds, OldLocation, OldVelocity);
    }
